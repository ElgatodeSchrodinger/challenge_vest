...
from api.stocks.repositories.company_repository import (
    CompanyRepository,
)
from api.stocks.repositories.stock_history_repository import (
    ...
    with sessionmakerFastAPI.context_session() as db:
        ...
        for company in companies:
            ...
            stock_history_repository.create(
                StockHistoryInput(**current_stock_info), symbol=company.symbol
            )
